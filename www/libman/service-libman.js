	...
	*/
	...
	function saveUpdates(data){
		...
		for(var idx in data){
			...
			var sql = "REPLACE INTO question_answer VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			var params = [i.id, i.type, i.question, i.a, i.b, i.c, i.d, i.answer, i.analysis, i.published_at, i.chapter_id,
						Common.dateFormat(new Date(i.last_modified), "yyyy-MM-dd hh:mm:ss"), i.real_seq, i.paper, i.point, i.law_id, i.emulate, i.chapter_level, i.picture];
			DB.multiTransaction(
				[
					[
						sql, 

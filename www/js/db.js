...
.factory('DB', function($cordovaSQLite, $rootScope, $q, $log, AUTH_EVENTS, $timeout){
    ...
    function initTestDB(){
      ...
      var dataArr = new Array(
			...
			"insert into law_chapter(id, law_id, name, last_modified) values(65, 10, '第十六章 危害公共安全罪', datetime('now'))",
